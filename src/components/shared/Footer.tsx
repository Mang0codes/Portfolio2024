	...
	return <>
        <VStack h='300px' justifyContent='center' spacing={10} w='100%'>
            <Stack 
                ...
                w='100%' spacing='2em'
            >
                <Link href='https://github.com/Mang0codes/PersonalPortfolio/blob/main/LICENSE.md' target='_blank'
            ...
            <Text textAlign='center'>Built by Albia Hossain using Next.js with ❤️<br />Thank you for reading to the end, I hope you enjoyed this website!</Text>
        </VStack>
    </>
}